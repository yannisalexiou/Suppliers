Ext.define('QuickStart.view.main.SupplierDatabaseViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.SupplierDatabaseViewController',
    ...
    onSelectFunction : function (grid, record, index, eOpts) {
        ...
        console.log('SupplierDatabaseViewController On Select');
        //Add new marker to google map
        this.addNewMarker(record);

        this.getController('mainview').justAFunction();
